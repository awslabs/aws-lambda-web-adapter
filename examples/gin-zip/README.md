...
This example shows how to use Lambda Adapter to run a Gin web application on managed golang runtime. 
...
Open HelloWorldApi's URL in a browser, you should see "hello world" on the page. 
