FROM public.ecr.aws/awsguru/php:82-2023.1.30.1-arm64 AS builder
...
FROM public.ecr.aws/awsguru/php:82-2023.1.30.1-arm64
COPY --from=public.ecr.aws/awsguru/aws-lambda-adapter:0.6.1-aarch64 /lambda-adapter /opt/extensions/lambda-adapter
